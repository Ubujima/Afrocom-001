...
Ubujima welcomes contributions of all kinds! You can make a huge impact without writing a single line of code
...
* Having more clear or up-to-date instructions in the README for both [`Ubujima'](https://github.com/Ubujima/Afrocom/blob/master/README.md) and [`brave-core`](https://github.com/Ubujima/Afrocom/blob/master/README.md).
...
For everything you'd need to get started, check out https://www.transifex.com/ubujima/
...
* Once you're up and running, find an interesting issue to fix. Check out issues labelled with [good first issue](https://github.com/brave/brave-browser/labels/good%20first%20issue)
  - most issues require knowledge of flutter dart (for example, pages using flutter dart and our [Ubujima UI library](https://github.com/ubujima/afrocom/ui))
...
* Fork the repository on GitHub (this might be [`Ubujima`](https://github.com/Ubujima/Afrocom).
