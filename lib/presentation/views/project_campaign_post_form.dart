...
class ProjectCampaignPostForm extends StatefulWidget {
  ...
  @override
  _ProjectCampaignPostFormState createState() =>
      _ProjectCampaignPostFormState();
}

class _ProjectCampaignPostFormState extends State<ProjectCampaignPostForm> {
  ...
  final _items = ProjectCampaignPostForm._categories
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Padding(
                                padding:
                                    const EdgeInsets.only(left: 16, right: 50),
                                child: Row(
                                  children: [
                                    InkWell(
                                      onTap: () {
                          ...
                          Padding(
                            ...
                            child: Card(
                              ...
                              child: MultiSelectDialogField<Category?>(
                                ...
                                items: ProjectCampaignPostForm._categories
