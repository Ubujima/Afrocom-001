...
import 'package:afrocom/meta/views/home/feed/market_category/market_post_block.dart';
            ...
            children: [
              Expanded(
                ...
                future: feedNotifier.fetchCategoryPosts(
                    collectionID:
                        DatabaseCredentials.MarketCategoryCollectionID,
                    context: context),
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: MarketPostBlock(post: posts[index]),
                          );
                        });
                  }
                  return Center(child: CircularProgressIndicator());
