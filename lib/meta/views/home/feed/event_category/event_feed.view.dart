...
import 'package:afrocom/meta/views/home/feed/event_category/event_post_block.dart';
import 'package:afrocom/meta/views/sub_categories/mood/mood.exports.dart';

class EventfeedView extends StatelessWidget {
  @override
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: EventPostBlock(post: posts[index]),
                          );
                        });
                  }
                  return Center(child: CircularProgressIndicator());
