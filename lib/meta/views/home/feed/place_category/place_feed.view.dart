...
import 'package:afrocom/meta/views/home/feed/place_category/place_post_block.dart';
import 'package:afrocom/meta/views/sub_categories/mood/mood.exports.dart';

class PlacefeedView extends StatelessWidget {
  @override
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: PlacePostBlock(post: posts[index]),
                          );
                        });
                  }
                  return Center(child: CircularProgressIndicator());
