...
class MoodPostBlock extends StatelessWidget {
  final dynamic post;
  const MoodPostBlock({required this.post});
  @override
  Widget build(BuildContext context) {
    MoodPostNotifier moodPostNotifier =
        Provider.of<MoodPostNotifier>(context, listen: true);
    List postAssets = post['postasset'];
    return Container(
      decoration: BoxDecoration(
          border: Border.all(
              width: 5,
              color: moodPostNotifier.setMoodPostColor(
                  postMoodType: post['postsubcategory'])!)),
      child: Column(
...
//http://res.cloudinary.com/slatecode/video/upload/v1631460098/afrocom/psksaxh3jfe1ie8umzr7.mp4
//https://res.cloudinary.com/slatecode/video/upload/v1631460098/afrocom/psksaxh3jfe1ie8umzr7.mp4