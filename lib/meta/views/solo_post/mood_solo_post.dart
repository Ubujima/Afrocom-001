...
class MoodSoloPost extends StatefulWidget {
  final SoloPostArguments soloPostArguments;
  const MoodSoloPost({required this.soloPostArguments});
  @override
  _MoodSoloPostState createState() => _MoodSoloPostState();
}

class _MoodSoloPostState extends State<MoodSoloPost> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                        child: Text(post['posttitle'],
                            style:
                                KConstantTextStyles.RegularText(fontSize: 14))),
                    vSizedBox1,
                    post['isvideo']
                        ? Container(
                            child: AspectRatio(
