...
class CampaignSoloPost extends StatefulWidget {
  final SoloPostArguments soloPostArguments;
  const CampaignSoloPost({required this.soloPostArguments});
  @override
  _CampaignSoloPostState createState() => _CampaignSoloPostState();
}

class _CampaignSoloPostState extends State<CampaignSoloPost> {
  @override
