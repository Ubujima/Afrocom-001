...
class EventSoloPost extends StatefulWidget {
  final SoloPostArguments soloPostArguments;
  const EventSoloPost({required this.soloPostArguments});
  @override
  _EventSoloPostState createState() => _EventSoloPostState();
}

class _EventSoloPostState extends State<EventSoloPost> {
  @override
              ...
              return Container(
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      child: Text("Event time - ${post['eventTime']}",
                          style: KConstantTextStyles.BoldText(fontSize: 14)),
                    ),
                    Container(
                      child: Text("Event date - ${post['eventDate']}",
                          style: KConstantTextStyles.BoldText(fontSize: 14)),
                    ),
                    Container(
                      child: Text("Event location - ${post['eventAddress']}",
                          style: KConstantTextStyles.BoldText(fontSize: 14)),
                    ),
                    Container(
