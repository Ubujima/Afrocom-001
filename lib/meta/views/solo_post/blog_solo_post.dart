...
class BlogSoloPost extends StatefulWidget {
  final SoloPostArguments soloPostArguments;
  const BlogSoloPost({required this.soloPostArguments});
  @override
  _BlogSoloPostState createState() => _BlogSoloPostState();
}

class _BlogSoloPostState extends State<BlogSoloPost> {
  @override
