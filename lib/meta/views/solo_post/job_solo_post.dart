...
class JobSoloPost extends StatefulWidget {
  final SoloPostArguments soloPostArguments;
  const JobSoloPost({required this.soloPostArguments});
  @override
  _JobSoloPostState createState() => _JobSoloPostState();
}

class _JobSoloPostState extends State<JobSoloPost> {
  @override
              ...
              return Container(
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      child: Text("Contract type - ${post['contractType']}",
                          style: KConstantTextStyles.BoldText(fontSize: 14)),
                    ),
                    Container(
                      child: Text(
                    ...
                    Container(
                      child: Text("Job location - ${post['jobAddress']}",
                          style: KConstantTextStyles.BoldText(fontSize: 14)),
                    ),
                    Container(
