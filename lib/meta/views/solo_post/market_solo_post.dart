...
class MarketSoloPost extends StatefulWidget {
  final SoloPostArguments soloPostArguments;
  const MarketSoloPost({required this.soloPostArguments});
  @override
  _MarketSoloPostState createState() => _MarketSoloPostState();
}

class _MarketSoloPostState extends State<MarketSoloPost> {
  @override
              ...
              return Container(
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      child: Text("Type - ${post['marketType']}",
                          style: KConstantTextStyles.BoldText(fontSize: 14)),
                    ),
                    Container(
                      child: Text(
                          "${post['marketType']} price - ${post['marketPrice']}",
                          style: KConstantTextStyles.BoldText(fontSize: 14)),
                    ),
                    Container(
